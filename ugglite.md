...
Device Changelogs :
• Bring back WiFi Display / Miracast support
• Update Power HAL to 1.2
• Introduce power libperfmgr
• Enable VoLTE/VoWiFi for more carrier
• Use AOSP Offline Charging
• Update ims prop
• Update coral fp to latest
• Enable zygote preforking for faster app launch
• Blacklist unexisted irq
• Update sdcard flags
